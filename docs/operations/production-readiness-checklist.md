...
| Tenancy | ready-local | Data Security | PostgreSQL runtime-role RLS read/write test and authenticated API smoke | 2026-07-30 | Clean migration + seed + RLS CI path configured; production exercise pending | Yes |
...
| Testing | ready-local | QA | backend 171 + RLS 1; frontend 16; build 92 routes | 2026-07-30 | Runtime coverage is 75.01%; external integration evidence remains | Yes |
